...
function Shell({ children }: { children: React.ReactNode }) {
  return (
    ...
    // layout.tsx). The tab bar's un-wrapped row of labels ("Desktop & mobile",
    // "Categories", …) was stretching THIS element wider than the viewport —
    // and with it, the whole page — rather than being contained by the tab
    // row's own `overflow-x-auto`. That scroll container never got a chance to
    // do its job because its own box had already grown past the screen.
    //
