 ...
 *  issue description, an optional name), so it comfortably fits the shared
 *  MobileSheet shell without needing to grow to near-full-height itself. */
export default function ReportSheet({ isOpen, onClose, listing, upLabel }: Props) {
  return (
    <MobileSheet isOpen={isOpen} onClose={onClose} title="Report a problem">
