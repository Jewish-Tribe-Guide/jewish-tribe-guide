...
export default function AddressPrompt() {
  ...
  return (
    <button
      onClick={handleClick}
      className="mt-1.5 inline-flex items-center gap-1.5 rounded-lg border border-amber-200 bg-amber-50 px-2.5 py-1.5 text-xs font-medium text-amber-800 hover:bg-amber-100 hover:border-amber-300 transition-colors cursor-pointer"
    >
