        ...
        {done ? (
          ...
          <>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {/* All three checkbox groups on one row too, for the same
                  reason — "All categories" used to sit alone on its own
                  line above New listings/Closures with no visual reason
                  the two were split. */}
              ...
              {!allCategories && (
                <div className="grid max-h-40 max-w-xl grid-cols-2 gap-x-4 gap-y-1.5 overflow-y-auto rounded-lg border border-slate-100 p-3 sm:grid-cols-3">
                  {eligible.map((c) => (
