...
import { Field, SelectInput, SectionDivider, SubmitButton } from './FormControls'
...
export default function FamilyHousingForm({ hospitalId, onClose }: Props) {
  ...
  if (submitted) {
    return (
      <div className="text-center py-6">
        ...
        <p className="text-sm text-muted mb-4">We'll be in touch shortly to coordinate family housing.</p>
  ...
  return (
    <form onSubmit={handleSubmit} noValidate className="space-y-4">
      ...
      <SectionDivider title="Housing Details" icon="🏠" />
