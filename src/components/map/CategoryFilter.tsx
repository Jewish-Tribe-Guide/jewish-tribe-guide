...
export default function CategoryFilter({ options, selected, onToggle, onAll, onNone }: Props) {
  ...
  return (
    ...
    // eating three wrapped rows of vertical space. chip-scroll (globals.css)
    // just styles the browser's own scrollbar — a real one, draggable and
    // clickable like any other, not a custom-built stand-in.
